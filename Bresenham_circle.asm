...
start:
	...
	mov COLOR, 6
	mov radius, 33    ;Радиус нашего круга.
	mov x0, 160    ;Номер строки, в котором будет находится центр круга
	mov y0, 100    ;Номер столбца, в котором будет находится центр круга
	call DrawCircle
